void main(List<String> args) {
  ...
  print(
      "Dizinin tersten yazılışı: ${sayilar3.reversed}"); // Bu işlem sadece anlık yapılır ve dizi üztünde bir değişiklik olmaz.
  print(sayilar3);
  sayilar3.remove(9); // İlk gördüğü 9' u siler.
  print(sayilar3);
  sayilar3.removeAt(2); // 2. index' i siler.
  print(sayilar3);
  print(sayilar3.contains(
      9)); // Parantez içine girilen değer liste içinde var mı yok mu onu sorgular.
